...
class Mage_Sales_Model_Order_Api extends Mage_Sales_Model_Api_Resource
{
	  ...
	  public function affitems($filters = null)
    {
		...
		//	$addattrbt = array("street","region","city","postcode","country_id");
			...
			$currentattset["street"] = $order->getShippingAddress()->getData("street");
        ...
        foreach ($order->getAllItems() as $item) {
			...
			$tamanhoglobal_label = $attr->getSource()->getOptionText($product->getData("tamanhoglobal"));
			Mage::log($tamanhoglobal_label , null, "color.log");
